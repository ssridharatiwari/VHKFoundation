...
public class NotificationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, NotificationModel obj, int position);
    }
    ...
    public NotificationAdapter(Context context, List<ListItem> consolidatedList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case ListItem.TYPE_GENERAL:
                View v1 = inflater.inflate(R.layout.item_notification, parent,
                        false);
        ...
        switch (viewHolder.getItemViewType()) {
            ...
            case ListItem.TYPE_DATE:
                try {
                    ...
                    dateViewHolder.tv_header1.setText(dateItem.getDate());
                } catch (Exception ex){
