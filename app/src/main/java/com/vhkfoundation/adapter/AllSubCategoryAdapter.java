...
public class AllSubCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private AllSubCategoryAdapter.OnItemClickListener mOnItemClickListener;
    private int animation_type = 0;

    public interface OnItemClickListener {
        void onItemClick(View view, SubCategoryModel obj, int position);
    }

    public void setOnItemClickListener(final AllSubCategoryAdapter.OnItemClickListener mItemClickListener) {
        this.mOnItemClickListener = mItemClickListener;
    }

    public AllSubCategoryAdapter(Context context, List<SubCategoryModel> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AllSubCategoryAdapter.OriginalViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AllSubCategoryAdapter.OriginalViewHolder) {
            AllSubCategoryAdapter.OriginalViewHolder view = (AllSubCategoryAdapter.OriginalViewHolder) holder;
